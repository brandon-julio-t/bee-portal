...
@section('body')
    <div x-data="{ showCreateForm: false }">
        <form x-data="{ ctid: '{{ optional($classTransaction)->id }}', currentSession: {{ $currentSession ?? -1 }} }"
            action="" class="container grid grid-cols-1 gap-4">
            <section class="card">
                <h2 class="text-xl font-bold mb-4">Course</h2>

                <div class="grid grid-cols-2 sm:grid-cold-3 md:grid-cols-4 gap-4">
                    @forelse ($classTransactions as $class)
                    ...
                    @empty
                        <div class="text-lg font-bold text-center w-full col-span-4">
                            No courses yet.
                        </div>
                    @endforelse
                </div>
        ...
        @if ($currentClassTransactionDetail)
                ...
                <div x-cloak x-transition x-show="showCreateForm" class="container my-8">
                    <form x-data="{ file: null }"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <button @click.prevent="showCreateForm = false"
